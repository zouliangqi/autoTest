...
if __name__ == "__main__":
    ...
    driver.get("http://10.124.131.80/#/")#https://baidu.com
...
#    win32api.keybd_event(VK_CODE['spacebar'],0,win32con.KEYEVENTF_KEYUP,0)
    time.sleep(2)#
#    driver.find_element_by_id("span-header").send_keys(Keys.ENTER)    
#    driver.find_element_by_css_selector('.span-header').click()  
    driver.execute_script("document.getElementsByClassName('span-header')[1].click();")
#    win32api.keybd_event(VK_CODE['enter'],0,0,0)
#    win32api.keybd_event(VK_CODE['enter'],0,win32con.KEYEVENTF_KEYUP,0)
    #driver.quit()
    #t3()
